    ...
    return (
        <input
            ...
            className={cn(
                ...
                "aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive focus:scale-[102%] transition-all duration-300 ease-in-out",
                className
            )}
            {...props}
        />
