...
const sendResetEmail = async (toEmail, resetLink) => {
    ...
    */
    ...
    const mailOptions = {
        ...
        to: toEmail,
        subject: "Reset Your Taskk Password",
        // Adding a plaintext version increases deliverability
        text: `
Hi ${userName},

We received a request to reset your password for your Taskk account.
...
${process.env.BASE_URL}
        ...
        <head>
            ...
            <title>Reset Your Taskk Password</title>
            <style>
            ...
            <style type="text/css">
                ...
                .reset-button {padding: 16px 36px !important; font-family: Arial, sans-serif; font-size: 16px; font-weight: bold;}
            </style>
            <![endif]-->
        </head>
        <body>
                        ...
                        <td align="center">
                            <div class="email-container">
                                ...
                                <div class="email-body">
                                    ...
                                    <div class="message">
                                        <p>We received a request to reset your password for your Taskk account. Click the button below to create a new password.</p>
                                    </div>
                                    
                                    <div class="button-container">
                                        <!--[if mso]>
                                        <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="${resetLink}" style="height:50px;v-text-anchor:middle;width:230px;" arcsize="8%" stroke="f" fillcolor="#2D6CDF">
                                        <w:anchorlock/>
                                        <center style="color:#ffffff;font-family:Arial,sans-serif;font-size:16px;font-weight:bold;">Reset My Password</center>
                                        </v:roundrect>
                                        <![endif]-->
                                        <!--[if !mso]><!-->
                                        <a href="${resetLink}" class="reset-button" target="_blank">Reset My Password</a>
                                        <!--<![endif]-->
                                    </div>
                                    
                                    <div class="message">
                                        <p><strong>This link will expire in 1 hour</strong> for security reasons. If you didn't request this password reset, you can safely ignore this email and your password will remain unchanged.</p>
                                    </div>
        ...
        headers: {
            ...
            'Feedback-ID': `reset:taskk:${process.env.EMAIL_USER}`
        }
    };
